...
import com.athena.ai.learningsession.dto.PracticeActivityResponse;
import com.athena.ai.learningsession.dto.QuizQuestionResponse;
import com.athena.ai.learningsession.dto.ReadingMaterialResponse;
import com.athena.ai.learningsession.dto.WatchingMaterialResponse;
    ...
    public LearningSessionResponse getDetail(UUID sessionId) {
        ...
        var watchings = watchingRepository.findBySessionIdOrderByOrderIndexAsc(sessionId).stream()
                .map(w -> new WatchingMaterialResponse(w.getId(), w.getTitle(), w.getDescription(),
                        w.getVideoQuery(), w.getVideoId(), w.getEstimatedMinutes(), w.getOrderIndex()))
                .toList();
